...
<head>
  ...
  */
  ...
  <link href="https://fonts.googleapis.com/css2?family=Almarai:wght@800&family=IBM+Plex+Sans+Arabic:wght@700&display=swap" rel="stylesheet">
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><span style="color:#f4511e;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>  login as a Admin </b></span></h4>
          </div>
              ...
              <div class="col-md-6">
                <form role="form" method="post" action="head.php?q=index.php">
                  <div class="form-group">
                    <input type="text" name="uname" maxlength="20" placeholder="User name" class="form-control" />
                  </div>
                  <div class="form-group">
    ...
    <div class="modal fade" id="login2">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cancel</span></button>
            <h4 class="modal-title"><span style="color:#f4511e;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>  login as a Teacher </b></span></h4>
          </div>
          <div class="modal-body title1">
            <div class="row">
              <div class="col-md-3"></div>
    ...
    <div class="container-fluid bg-grey">
      <div class="row">
        ...
        <div class="col-sm-8">
          <h2 style="text-align: center;">This Project made with ❤️ by</h2>
          <h4>
            <li>Mohammed AbuJasser (Abu Al-Saed)</li>
            <li>Mohammed Ghassan (Abu Ghassan)</li>
            <li>Oday Al-Taweel (AbuMohammed)</li>
          </h4>
      ...
      <div class="modal-dialog">
        <div class="modal-content title1">
          <div class="modal-header">
            ...
            <h4 class="modal-title title1"><span style="color:#f4511e;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>login as a Student </b></span></h4>
          </div>
            ...
            <form class="form-horizontal" action="login.php?q=index.php" method="POST">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input id="password" name="password" placeholder="Enter the password" class="form-control input-md" type="password">
            ...
            <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input id="name" name="name" placeholder="Student name" class="form-control input-md" type="text">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input id="mob" name="mob" placeholder="Phone number" class="form-control input-md" type="number">
