  ...
  <div class="header">
    <div class="row">
      ...
      if (!(isset($_SESSION['email']))) {
        ...
        include_once 'dbConnection.php';
        echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="headdash.php" class="log log1">' . $email . '</a>&nbsp;|&nbsp;<a href="logout.php?q=headdash.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
      } ?>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li <?php if (@$_GET['q'] == 2) echo 'class="active"'; ?>><a href="headdash.php?q=2">Students</a></li>
          <li <?php if (@$_GET['q'] == 3) echo 'class="active"'; ?>><a href="headdash.php?q=3">Response</a></li>
          <li class="dropdown <?php if (@$_GET['q'] == 4 || @$_GET['q'] == 5) echo 'active'; ?>">
            ...
            <ul class="dropdown-menu">
              <li><a href="headdash.php?q=4">Add a new teacher</a></li>
              <li><a href="headdash.php?q=5">Delete a teacher</a></li>
            </ul>
          </li>
        </ul>
      </div><!-- /.navbar-collapse -->
...
<tr><td><b>No.</b></td><td><b>Subject</b></td><td><b>Question numbers</b></td><td><b>Full mark</b></td><td><b>Mark for each correct question</b></td><td><b>Mark for each Wrong question</b></td><td><b>Time</b></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result)) {
            ...
            if ($rowcount == 0) {
              ...
              echo '<tr style="color:#99cc32"><td>' . $c++ . '</td><td>' . $title . '&nbsp;<span title="This quiz has already been solved by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>' . $total . '</td><td>' . $sahi * $total . '</td><td>' . $time . '&nbsp;min</td>
	</tr>';
            }
          }
          $c = 0;
...
<tr ><td><b>No.</b></td><td><b>Student name</b></td><td><b>Sex</b></td><td><b>College</b></td><td><b>Result</b></td></tr>';
          $c = 0;
        ...
        <?php if (@$_GET['q'] == 1) {
          ...
          echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>NO.</b></td><td><b>Student name</b></td><td><b>Sex</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Phone number</b></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result)) {
            $name = $row['name'];
            $mob = $row['mob'];
	...
	<td><a title="Delete User" href="update.php?demail=' . $email . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
        ...
        <?php if (@$_GET['q'] == 3) {
          ...
          echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>NO.</b></td><td><b>Subjects</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result)) {
            $date = $row['date'];
...
<span style="line-height:35px;padding:5px;">&nbsp;<b>Time:</b>&nbsp;' . $time . '</span><span style="line-height:35px;padding:5px;">&nbsp;<b>By:</b>&nbsp;' . $name . '</span><br />' . $feedback . '</div></div>';
        ...
        if (@$_GET['q'] == 4) {
          echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Write new teacher details</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="email" placeholder="Add email" class="form-control input-md" type="email">
